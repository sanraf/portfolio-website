...
function Card() {
  ...
  <div className="main">
    <ul className="cards">
        ...
        <li className="cards_item">
        <div className="card">
            <div className="card_image"><img src={icon} alt="a Reuben sandwich on wax paper. "/></div>
            <div className="card_content">
            ...
            <div className="card_text">
                ...
                <p>This unforgettable sandwich has all of the classNameic Reuben elements: corned beef, rye bread, creamy Russian dressing, sauerkraut, plus a sweet gherkin pickle. No substitions please!
                </p>
        ...
        <li className="cards_item">
        <div className="card">
            <div className="card_image"><img src={icon} alt="A side view of a plate of figs and berries. "/></div>
            <div className="card_content">
